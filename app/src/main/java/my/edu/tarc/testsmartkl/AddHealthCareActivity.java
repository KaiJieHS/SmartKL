...
public class AddHealthCareActivity extends AppCompatActivity {
    ...
    public void saveRecord(View v) {
        ...
        try {
            ...
            addFeedback(this, "https://circumgyratory-gove.000webhostapp.com/insert_healthcare.php", healthcare);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void addFeedback(Context context, String url, final HealthCare healthcare) {
